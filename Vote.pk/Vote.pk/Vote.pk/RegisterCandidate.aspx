<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterCandidate.aspx.cs" Inherits="Vote.pk.RegisterCandidate" %>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="RegisterCandidate.aspx">Register Candidate</a></li>
                            ...
                            <div class="panel-body">
                                ...
                                <div>
                                    <form class="form-horizontal" name="signup" method="post" action="signup" style="padding: 0; margin: auto;">
                                        ...
                                        <div class="from-group col-sm-6">
                                            <label>Details</label>
                                            <asp:TextBox ID="details" type="text" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                            
                                        </div>
                                        <div class="from-group col-sm-6">
                                            <label for="to">Electoral Sign Name</label>
                                            <span id="errTo" style="color: red;"></span>
                                            <asp:TextBox ID="electoralsignname" type="text" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="electoralsignname" ErrorMessage="This field is required" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="from-group-btn col-sm-12">
                                            <asp:FileUpload ID="file" runat="server"></asp:FileUpload>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="file" ErrorMessage="This field is required" ForeColor="Red"></asp:RequiredFieldValidator>
                                            <br>
                                        </div>
                                        <br>
                                        <br>
