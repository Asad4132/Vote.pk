<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Vote.pk.Login" %>
                    ...
                    <div class="panel-group">
                        <div class="panel panel-default panel-transparent">
                            <div class="panel-heading">
                                <legend style="text-align: center;">SignIn Information</legend>
                            </div>
                                ...
                                <div>
                                    <form class="form-horizontal" name="signin" method="post" action="signup" style="padding: 0; margin: auto;">
                                        ...
                                        <div class="from-group-btn col-sm-12">
                                            <asp:Button ID="signup" OnClick="Button1_Click" class="btn btn-primary trans-input-area" type="submit" Style="width: 100%; text-align: center;" Text="Sign In" runat="server"></asp:Button>
