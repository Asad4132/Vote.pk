<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Voters.aspx.cs" Inherits="Vote.pk.Voters" %>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="Voters.aspx">Voters</a></li>
                    ...
                    <div class="panel-group">
                        <div class="panel panel-default panel-transparent">
                            <div class="panel-heading">
                                <legend style="text-align: center;">Voters Information</legend>
                            </div>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                                            ...
                                            <Columns>
                                                <asp:TemplateField ShowHeader="False">
                                                    <ItemTemplate>
                                                        <asp:Button ID="Button1" class="btn btn-danger" OnClick="Button1_Click" Text="Delete" runat="server" OnClientClick="return Confirmation();" CommandName="AddToCart" CommandArgument='<%#Eval("CNIC")%>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
