<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Candidates.aspx.cs" Inherits="Vote.pk.Candidates" %>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                                            ...
                                            <Columns>
                                                <asp:TemplateField ShowHeader="False">
                                                    <ItemTemplate>
                                                        <asp:Button ID="Button1" class="btn btn-danger trans-input-area" OnClick="Button1_Click" Text="Delete" runat="server" OnClientClick="return Confirmation();" CommandName="AddToCart" CommandArgument='<%#Eval("CNIC") + ";" +Eval("Constituency")%>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <Columns>
